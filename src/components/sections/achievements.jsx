...
import { Award, Trophy, Code, Target, Users, Calendar } from 'lucide-react';
  ...
  const achievements = [
    {
      ...
      image: `${SIH2024}`,
      description: "Winner of Smart India Hackathon 2024 for developing innovative solutions to real-world problems.",
      skills: ["React.js", "Node.js", "Express.js", "Real World Problem Solving", "MongoDB"],
    ...
    },
    {
      ...
      image: `${InterIIITA}`,
      description: "Secured 3rd place in the 4×100m relay, demonstrating teamwork, speed, and coordination.",
    ...
    },
    {
      ...
      orientation: "landscape",
      image: `${AhoubaCP}`,
      description: "Recognized for exceptional performance in competitive programming, consistently securing top positions on the Ahouba platform through strong analytical thinking and efficient coding practices.",
      skills: ["C++ Programming", "Algorithm Design", "Problem-Solving Strategies"],
    ...
    },
    {
      ...
      orientation: "landscape",
      image: `${Voulenteer}`,
      description: "Recognition for outstanding volunteer service and community engagement initiatives.",
