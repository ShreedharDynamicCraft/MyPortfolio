  ...
  return (
    <div id="experience" className="relative bg-indigo-50 py-20 px-4 md:px-8 font-['Be_Vietnam_Pro'] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl xl:text-[12rem] font-bold text-gray-400 opacity-30 blur-[3px] select-none transform rotate-90 lg:rotate-0">
          EXPERIENCE
        </div>
      </div>

      {/* Floating Decorative Elements */}
      <div className="absolute top-10 left-10 w-20 h-20 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-20 animate-bounce" style={{animationDuration: '3s'}}></div>
      <div className="absolute top-1/4 right-10 w-12 h-12 bg-gradient-to-r from-blue-400 to-cyan-400 transform rotate-45 opacity-30 animate-spin" style={{animationDuration: '8s'}}></div>
      ...
      <div className="absolute bottom-10 right-1/3 w-8 h-8 bg-gradient-to-r from-green-400 to-teal-400 transform rotate-12 opacity-30 animate-bounce" style={{animationDelay: '1s'}}></div>
            ...
            >
              ...
              <div className="relative perspective-1000">
                <div className={`relative bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden transform-gpu transition-all duration-700 hover:scale-105 hover:rotate-1 hover:shadow-2xl shadow-xl group-hover:shadow-[#4e45d5]/20 border border-white/50`}>
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${exp.gradient} opacity-5 group-hover:opacity-10 transition-opacity duration-500`}></div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                      ...
                      <div className="lg:w-1/3">
                        ...
                        <div className="inline-block mb-4">
                          <span className={`px-4 py-2 rounded-full text-xs font-bold tracking-wider uppercase bg-gradient-to-r ${exp.gradient} text-white shadow-lg group-hover:shadow-xl transform group-hover:scale-110 transition-all duration-300`}>
                            {exp.type === 'current' ? '✨ CURRENT' : exp.type === 'internship' ? '🎓 INTERNSHIP' : '💼 PREVIOUS'}
                          </span>
                        </div>
                ...
                {/* 3D Shadow Effect */}
                <div className={`absolute inset-0 bg-gradient-to-br ${exp.gradient} rounded-2xl transform translate-x-2 translate-y-2 opacity-20 group-hover:translate-x-4 group-hover:translate-y-4 group-hover:opacity-30 transition-all duration-500 -z-10`}></div>
              </div>
            </div>
          ))}
        </div>
